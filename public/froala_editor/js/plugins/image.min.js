...
! function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        imageUpload: !0,
        imageUploadURL: "http://localhost/academy/public/api/upload/frolla",
        // imageUploadURL: "http://localhost/academy/public/upload_image.php",
        ...
        function ea() {
            b.opts.imagePaste ? b.$el.find("img[data-fr-image-pasted]").each(function(c, d) {
                ...
                if (0 === d.src.indexOf("data:")) da(d);
                    ...
                    a(d).remove(), b.selection.restore()) : a(d).removeAttr("data-fr-image-pasted")
