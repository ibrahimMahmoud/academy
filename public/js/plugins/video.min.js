...
! function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        videoUploadParams: {},
        videoUploadToS3: !1,
        videoUploadURL: "http://127.0.0.1:8000/upload_video.php"
        ...
        function ja() {
            R(), b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "span.fr-video", function() {
                ...
                return "false" == a(this).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable") || void J.call(this, b)
            }), b.events.on("keydown", function(c) {
                var d = c.which;
